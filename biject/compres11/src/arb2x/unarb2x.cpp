/*
  UNARB2X.CPP Heres one for the Gipper
    See Notes on ARB2X.CPP this is opposite
  ...
  to a 64 bit high low bijective adaptive coder
TYPICAL USE "unarb2x filein fileout"
COMPLIE first compile all minor routines then
  gcc unarb2x.cpp *.o -o unarb2x.exe
*/
...
main(int argc, char *argv[])
{
   int             ticker = 0;
   int             ch;
   fprintf(stderr, "Bijective Arithmetic 2 state uncoding version 20060602\n");
