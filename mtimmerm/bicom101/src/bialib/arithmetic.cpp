...
ArithmeticEncoder::ArithmeticEncoder(ArithmeticModel *mod, IOByteSource *src, bool autodel)
    : m_in(src, autodel)
{
    model = mod;
...
ArithmeticDecoder::ArithmeticDecoder(ArithmeticModel *modelin, IOByteSource *src, bool autodel)
    : m_in(src, autodel)
{
    model = modelin;
    low = 0;
